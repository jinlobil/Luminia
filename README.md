...
현재 그래픽은 외부 유료 에셋이 아니라 Unity UI 도형과 런타임에서 직접 생성하는 24×24 오리지널 도트 유닛으로 구성했습니다. 수호기사·궁수·치유사·화염술사·마족은 서로 다른 무기와 실루엣을 사용하며, 다음 단계에서는 라이선스가 명확한 무료 애니메이션 에셋으로 확장할 예정입니다.
